 ...
 */
public class CastleScoreBox extends ParentScoreBox {
	/**
	...
	/**
	 * Determines whether the given array of die includes three dice
	 * of one value and three dice of another value.
